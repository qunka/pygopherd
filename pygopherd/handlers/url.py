...
class HTMLURLHandler(BaseHandler):
    ...
    def canhandlerequest(self):
        """We can handle the request if it starts with URL: and has a URL
        scheme."""
    ...
    def write(self, wfile):
        ...
        outdoc += """
        <TITLE>Exiting Gopher</TITLE><META CHARSET="UTF-8"></HEAD><BODY>
        You are following a link from gopher to another protocol.  You
        will be automatically taken to your destination shortly.  If
        you do not get sent there, please click """
        outdoc += '<A HREF="%s">here</A> ' % url
        outdoc += 'to go to your destination.<P>The URL linked is:<P>'
        outdoc += '<A HREF="%s">%s</A>' % (url, url)
        outdoc += """<P>Thanks for using gopher!<P>
